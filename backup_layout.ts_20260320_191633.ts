...
async function executeCommandAsync(psCmd: string, st: number): Promise<void> {
  ...
  if (!document.getElementById('ps-ide-css')) {
    ...
    s.textContent = '.ps-ide-out{font-family:Consolas,monospace;font-size:12px;color:#d4d4d4;white-space:pre;line-height:1.5;padding:0 0 0 2px;overflow-x:auto;}.ps-ide-err{font-family:Consolas,monospace;font-size:12px;color:#f48771;white-space:pre;line-height:1.5;padding:0 0 0 2px;}.ps-ide-meta{font-family:Consolas,monospace;font-size:10px;color:#4e4e4e;padding:0 0 4px 2px;}.ps-ide-running{font-family:Consolas,monospace;font-size:12px;color:#608b4e;padding:0 0 0 2px;line-height:1.5;position:relative;}@keyframes ps-scan2{0%{width:0%;opacity:1}70%{width:100%;opacity:1}100%{width:100%;opacity:0}}.ps-scanline2{display:block;height:1px;background:#569cd6;animation:ps-scan2 1.4s ease-in-out infinite;margin-top:2px;opacity:0.6;}';
...
function showTerminalHelp(): void {
  ...
  helpPanel.innerHTML = `
    ...
    <div style="padding: 20px; overflow-y: auto; max-height: calc(80vh - 60px);">
      ...
      <div style="margin-bottom: 24px;">
        <h3 style="color: #39c5cf; font-size: 14px; font-weight: 600; margin: 0 0 12px 0;">&#128202; Project Analysis</h3>
        <div style="display: grid; gap: 8px;">
          <div style="display: flex; background: #0d1117; border-radius: 6px; padding: 10px 14px;">
            <code style="color: #79c0ff; min-width: 120px; font-family: 'JetBrains Mono', monospace;">analyse</code>
            <span style="color: #8b949e; font-size: 13px;">List all project files grouped by type</span>
          </div>
          <div style="display: flex; background: #0d1117; border-radius: 6px; padding: 10px 14px;">
            <code style="color: #79c0ff; min-width: 120px; font-family: 'JetBrains Mono', monospace;">project</code>
            <span style="color: #8b949e; font-size: 13px;">Full project summary (name, path, file count)</span>
          </div>
          <div style="display: flex; background: #0d1117; border-radius: 6px; padding: 10px 14px;">
            <code style="color: #79c0ff; min-width: 120px; font-family: 'JetBrains Mono', monospace;">todos</code>
            <span style="color: #8b949e; font-size: 13px;">Find all TODO / FIXME comments in code</span>
          </div>
          <div style="display: flex; background: #0d1117; border-radius: 6px; padding: 10px 14px;">
            <code style="color: #79c0ff; min-width: 120px; font-family: 'JetBrains Mono', monospace;">count</code>
            <span style="color: #8b949e; font-size: 13px;">Count total lines of code in src folder</span>
          </div>
          <div style="display: flex; background: #0d1117; border-radius: 6px; padding: 10px 14px;">
            <code style="color: #79c0ff; min-width: 120px; font-family: 'JetBrains Mono', monospace;">deps</code>
            <span style="color: #8b949e; font-size: 13px;">Check dependencies and node_modules status</span>
          </div>
          <div style="display: flex; background: #0d1117; border-radius: 6px; padding: 10px 14px;">
            <code style="color: #79c0ff; min-width: 120px; font-family: 'JetBrains Mono', monospace;">scripts</code>
            <span style="color: #8b949e; font-size: 13px;">Show available npm run scripts</span>
          </div>
        </div>
      </div>
