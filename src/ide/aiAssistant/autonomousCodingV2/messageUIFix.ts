...
function setupObserver(): void {
  ...
  observerInstance = new MutationObserver((mutations) => {
    ...
    if (shouldProcess) {
      ...
      debounceTimer = window.setTimeout(enhanceCodeBlocks, 150); // Slightly longer debounce
    }
  });
...
export async function initMessageUIFix(): Promise<void> {
  ...
  console.log('🚀 [MessageUIFix] Initializing v14 (Language Fix + Streaming Protection + MarkdownFix Guard)...');
