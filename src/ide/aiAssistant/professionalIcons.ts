...
export const PROFESSIONAL_ICONS = {
  ...
  // Add file by path - Link / chain
  link: `<svg viewBox="0 0 24 24" width="16" height="16" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
