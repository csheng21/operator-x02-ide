// utils/perfManager.ts
// X02 Performance Manager - Interval throttle manager
// Extracted from main.ts. Runs automatically on import.
// Usage: (window as any).X02Perf.throttle(5)  /  .restore()  /  .status()
