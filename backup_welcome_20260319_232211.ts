...
function injectTerminalWelcomeUI(): void {
  ...
  el.innerHTML =
    ...
    '<div style="color:#4ec94e;font-weight:600;margin-bottom:1px">  &nbsp; &#9889; OPERATOR X02</div>' +
    ...
    '<div style="color:#4a7c4a;font-style:italic;margin-top:2px">  &nbsp; Coding is Art. Feel it. Enjoy it.</div>' +
