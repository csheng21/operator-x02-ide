...
function injectTerminalWelcomeUI(): void {
  ...
  el.innerHTML =
    '<div style="color:#2ea043;margin-bottom:2px">  ' + tl + '</div>' +
    '<div style="color:#4ec94e;font-weight:600;margin-bottom:2px">  &nbsp; &#9889; OPERATOR X02 &middot; AI Code IDE &middot; v1.5.0-beta</div>' +
    '<div style="color:#2ea043;margin-bottom:8px">  ' + bl + '</div>' +
    '<div style="color:#6a9a6a;margin-bottom:6px">  &nbsp; ' + dStr + ' &middot; ' + tStr + '</div>' +
    '<div style="margin-bottom:4px">' + hr + '</div>' +
    dot + '<span style="color:#5cb85c">Run &nbsp;&nbsp;&nbsp;&nbsp; Ctrl+Shift+B</span><br>' +
    dot + '<span style="color:#5cb85c">AI Chat &nbsp; Ctrl+Shift+A</span><br>' +
    dot + '<span style="color:#5cb85c">Surgical &nbsp; Active</span><br>' +
    dot + '<span style="color:#5cb85c">GPU &nbsp;&nbsp;&nbsp;&nbsp; Live monitor active</span><br>' +
    '<div style="margin-top:4px">' + hr + '</div>' +
    '<div style="color:#4a7c4a;font-style:italic;margin-top:4px">  &nbsp; Coding is Art. Feel it. Enjoy it.</div>' +
    '<div style="margin-top:6px">' + hr + '</div>';
